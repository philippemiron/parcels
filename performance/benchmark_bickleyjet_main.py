...
from parcels.particleset import ParticleSetSOA, ParticleSetSOA_Benchmark, ParticleSetAOS
from parcels.kernel import KernelSOA, KernelSOA_Benchmark, KernelAOS
...
pset = None
pset_modes = ['soa', 'soab', 'aos']
pset_mode = {
    'soa': {'pset': ParticleSetSOA, 'pfile': ParticleFileSOA, 'kernel': KernelSOA},
    'soab': {'pset': ParticleSetSOA_Benchmark, 'pfile': ParticleFileSOA, 'kernel': KernelSOA_Benchmark},
